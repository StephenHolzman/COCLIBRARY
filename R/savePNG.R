savePNG <- function(plot = NULL, path = getwd(), width = 600, height = 600, title = "", subtitle = "", cite = "", author = "", headerbackground = "#2E2E2E", headerfontcol = "white", footerbackground = "#2E2E2E", footerfontcol = "white", fontfamily = "Arial"){
  ...
  grid.text(author, x=unit(.99,"npc"),y=unit(20/height,"npc"),just="right",gp=gpar(fontsize=18,fontfamily=fontfamily,fontface="bold", col=footerfontcol))
  dev.off() 
}