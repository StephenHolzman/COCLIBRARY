#Plotting
basicBoxplot <- function(data, xvar, yvar, colourvar, stat, pos, flip, title, subtitle, cite, author, ylabel, xlabel, path, ylimits, ybreaks, ylabels, colpal = c("#B3B0D8", "#E4E499", "#F8ADAD", "#A0DADD", "#EFC786", "#919191", "#E2B9D7", "#B2D9A2","#A05F6B","000000")) {
